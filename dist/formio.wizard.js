...
},{"./base/Base":4,"./index":21,"lodash/clone":217,"lodash/each":223,"lodash/reduce":249,"lodash/remove":250,"native-promise-only":257}],2:[function(require,module,exports){
'use strict';
...
},{"lodash/each":223,"lodash/get":226,"lodash/has":227,"lodash/isArray":231}],3:[function(require,module,exports){
'use strict';
...
},{"../../locals/en":40,"../../utils":46,"../Validator":2,"i18next":65,"lodash/assign":216,"lodash/clone":217,"lodash/debounce":220,"lodash/each":223,"lodash/get":226,"lodash/isArray":231,"native-promise-only":257,"text-mask-all/vanilla":261}],5:[function(require,module,exports){
'use strict';
...
exports.BaseWithDatasourceComponent = undefined;
...
var BaseWithDatasourceComponent = exports.BaseWithDatasourceComponent = function (_BaseComponent) {
  _inherits(BaseWithDatasourceComponent, _BaseComponent);

  function BaseWithDatasourceComponent() {
    _classCallCheck(this, BaseWithDatasourceComponent);

    return _possibleConstructorReturn(this, (BaseWithDatasourceComponent.__proto__ || Object.getPrototypeOf(BaseWithDatasourceComponent)).apply(this, arguments));
  }

  _createClass(BaseWithDatasourceComponent, [{
    key: 'loadItems',
    value: function loadItems(url, input, headers, options) {
      ...
      // Make the request.
      return _formio2.default.request(url, null, null, headers, options);
    }
  }, {
    key: 'updateItems',
    value: function updateItems(container) {
      var _this2 = this;
      ...
      switch (this.component.dataSrc) {
        ...
        case 'json':
          ...
          break;
        case 'resource':
          this.loadItems(_formio2.default.getAppUrl() + '/form/' + this.component.data.resource + '/submission').then(function (response) {
            return _this2.setItems(response, container);
          });
          break;
        case 'url':
    ...
    value: function itemValue(data) {
      return this.component.valueProperty ? (0, _get3.default)(data, this.component.valueProperty) : data;
    }
  }, {
    key: 'itemLabel',
    value: function itemLabel(data) {
      return this.component.labelProperty ? (0, _get3.default)(data, this.component.labelProperty) : data;
    }
  }, {
    key: 'itemTemplate',
  ...
  return BaseWithDatasourceComponent;
}(_Base.BaseComponent);

},{"../../formio":38,"../base/Base":4,"choices.js":47,"lodash/each":223,"lodash/get":226,"lodash/isArray":231}],6:[function(require,module,exports){
'use strict';
...
},{"../Components":1,"lodash/each":223}],10:[function(require,module,exports){
'use strict';
...
},{"../Components":1,"lodash/each":223,"lodash/isObject":237}],11:[function(require,module,exports){
'use strict';
...
},{"../textfield/TextField":34,"lodash/get":226,"text-mask-all/addons/dist/createNumberMask":260,"text-mask-all/vanilla":261}],13:[function(require,module,exports){
'use strict';
...
},{"../base/Base":4,"../index":21,"lodash/cloneDeep":218,"lodash/each":223,"lodash/isArray":231}],14:[function(require,module,exports){
'use strict';
...
},{"../base/Base":4,"flatpickr":49,"lodash/each":223,"lodash/get":226}],15:[function(require,module,exports){
'use strict';
...
},{"../base/Base":4,"lodash/each":223,"lodash/get":226,"moment":256}],16:[function(require,module,exports){
'use strict';
...
},{"../textfield/TextField":34}],17:[function(require,module,exports){
'use strict';
...
},{"./address/Address":3,"./base/Base":4,"./button/Button":6,"./checkbox/Checkbox":7,"./columns/Column":8,"./columns/Columns":9,"./container/Container":10,"./content/Content":11,"./currency/Currency":12,"./datagrid/DataGrid":13,"./datetime/DateTime":14,"./day/Day":15,"./email/Email":16,"./fieldset/Fieldset":17,"./gmap/Gmap":18,"./hidden/Hidden":19,"./html/HTML":20,"./number/Number":22,"./panel/Panel":23,"./password/Password":24,"./phonenumber/PhoneNumber":25,"./radio/Radio":26,"./resource/Resource":27,"./select/Select":28,"./selectboxes/SelectBoxes":29,"./signature/Signature":30,"./survey/Survey":31,"./table/Table":32,"./textarea/TextArea":33,"./textfield/TextField":34,"./unknown/Unknown":35,"./well/Well":36}],22:[function(require,module,exports){
'use strict';
...
var _BaseWithDatasource = require('../base/BaseWithDatasource');
...
var RadioComponent = exports.RadioComponent = function (_BaseWithDatasourceCo) {
  _inherits(RadioComponent, _BaseWithDatasourceCo);
  ...
  _createClass(RadioComponent, [{
    ...
    key: 'setItems',
    value: function setItems(items, container) {
      var _this2 = this;
      ...
      (0, _each3.default)(items, function (item) {
        var value = _this2.itemValue(item);
        ...
        var inputId = _this2.inputId + '-' + value;
        _this2.info.attr.id = inputId;
        _this2.info.attr.value = value;
...
}(_BaseWithDatasource.BaseWithDatasourceComponent);

},{"../base/BaseWithDatasource":5,"lodash/each":223}],27:[function(require,module,exports){
'use strict';
...
var SelectComponent = exports.SelectComponent = function (_BaseWithDatasourceCo) {
  _inherits(SelectComponent, _BaseWithDatasourceCo);
...
},{"../../formio":38,"../base/BaseWithDatasource":5,"choices.js":47,"lodash/each":223,"lodash/get":226,"lodash/isArray":231}],29:[function(require,module,exports){
'use strict';
...
},{"./formio":38,"./formio.form":37,"lodash/each":223,"native-promise-only":257}],40:[function(require,module,exports){
'use strict';
...
},{"lodash/get":226}],47:[function(require,module,exports){
